...
getInfoFixKey <- function(Directory,csvname, babel_dir){
    ...
    #need to add pattern to skip the mols and tsvs
		wantedmat <- matrix(0,length(Files),(23))
...
colnames(wantedmat) <- c("ACCESSION","LICENSE","NAME","FORMULA","EXACT_MASS","IUPAC","INCHIKEY","SMILES","CSID","INSTRUMENT","INSTRUMENT_TYPE","MS_TYPE","IONIZATION","ION_MODE","FRAGMENTATION_MODE","COLL_E","RESOLUTION","BASE_PEAK","PRECURSOR_MZ","PRECURSOR_TYPE","SPLASH","EULINK","JPLINK")
